...
-file("src/leex_yecc/sui_yecc.yrl", 16).
init(Cli) ->
{[Cli], cmd(Cli)}.
...
-file("src/leex_yecc/sui_yecc.yrl", 5).
...
-file("src/leex_yecc/sui_yecc.yrl", 6).
...
-file("src/leex_yecc/sui_yecc.yrl", 10).
...
-file("src/leex_yecc/sui_yecc.yrl", 9).
...
-file("src/leex_yecc/sui_yecc.yrl", 8).
...
-file("src/leex_yecc/sui_yecc.yrl", 7).
...
-file("src/leex_yecc/sui_yecc.yrl", 32).
